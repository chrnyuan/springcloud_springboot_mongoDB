 ...
 *
 */
@Document(collection = "RecommendMemberCollection")
public class RecommendMemberCollectionEntity {
	...
	public String toString() {
		return "RecommendMemberCollectionEntity [id=" + id + ", unitId=" + unitId + ", beaconMac=" + beaconMac
				+ ", createdTimeStamp=" + createdTimeStamp + ", RecommendInfoList=" + RecommendInfoList + "]";
	}
}
